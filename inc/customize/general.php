...
function beautiful_theme_setting( $wp_customize ) {
    ...
    $wp_customize->add_control(
        new WP_Customize_Control(
            $wp_customize,
            'beautiful_genral_font',array(
                'label'          => __( 'Primary Font Family', 'beautiful' ),
                'section'        => 'beautiful_general',
                'settings'       => 'beautiful_genral_font',
                'type'           => 'select',
                'priority'       => 5,
    ...
    $wp_customize->add_control(
        new WP_Customize_Control(
            $wp_customize,
            'beautiful_header_font',array(
                'label'          => __( 'Headers Font Family', 'beautiful' ),
                'section'        => 'beautiful_general',
                'settings'       => 'beautiful_header_font',
                'type'           => 'select',
                'priority'       => 5,
                'choices'        => array("ABeeZee" => "ABeeZee",
                    "Abel" => "Abel",
    ...
    $wp_customize->add_control(
        new WP_Customize_Image_Control(
            $wp_customize,
            'beautiful_favicon',array(
                'label'          => __( 'favicon', 'beautiful' ),
                'section'        => 'beautiful_general',
                'settings'       => 'beautiful_favicon',
                'priority'       => 4
            )
        )
    );
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            $wp_customize,
            'beautiful_link_color',array(
                'label'          => __( 'link color', 'beautiful' ),
                'section'        => 'beautiful_general',
                'settings'       => 'beautiful_link_color',
                'priority'       => 2
            )
        )
    );
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            $wp_customize,
            'beautiful_link_color_hover',array(
                'label'          => __( 'link color on hover', 'beautiful' ),
                'section'        => 'beautiful_general',
                'settings'       => 'beautiful_link_color_hover',
                'priority'       => 3
            )
        )
    );
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            $wp_customize,
            'beautiful_post_font_color',array(
                'label'          => __( 'Base Font Color', 'beautiful' ),
                'section'        => 'beautiful_general',
                'settings'       => 'beautiful_post_font_color',
                'priority'       => 5
            )
        )
    );
...
add_action( 'customize_register', 'beautiful_theme_setting' );